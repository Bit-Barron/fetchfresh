...
const RecommendedProducts: React.FC<RecommendedProductsProps> = ({
  ...
  // Function to safely decode a URI component
    ...
    <div className="container mx-auto px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {products
          ...
          .slice(0, 20)
          .map((item) => {
            // Decode the title and image URL safely
            const decodedTitle = safeDecodeURIComponent(item.title);
            const decodedImageURL = safeDecodeURIComponent(
